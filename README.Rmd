...
This function was built based on the structure in which author-affiliation information is presented:


Thus, one can simply copy and paste this information and use it as parameters for the the function:
